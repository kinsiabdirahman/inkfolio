 ...
 */
export function getAccountPlan(agent: AccessAgent, account: API.AccountDID): Promise<w3caps.Space.Store.Schema.Result<API.PlanGetSuccess, API.HandlerNotFound | API.HandlerExecutionError | API.InvalidAudience | API.Unauthorized | API.PlanNotFound>>;
