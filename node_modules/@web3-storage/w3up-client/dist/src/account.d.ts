...
export class AccountPlan {
     ...
     */
    get(): Promise<API.Result<API.PlanGetSuccess, API.HandlerNotFound | API.HandlerExecutionError | API.InvalidAudience | API.Unauthorized | import("@web3-storage/capabilities/types").PlanNotFound>>;
